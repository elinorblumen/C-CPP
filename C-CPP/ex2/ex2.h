...
typedef struct Node {
    struct Node *next; // this member should allow access to next node in the list.
    // (think - pointer or instance?)
    struct Node *prev; // this member should allow access to next node in the list.
    // (think - pointer or instance?)
...
typedef struct LinkedList {
    struct Node *head; // this member should allow access to the first node in the linked list. (think -
    // pointer or instance?
    struct Node *tail; // this member should allow access to the node at the end of the linked list.
    // (think - pointer or instance?)
} LinkedList;
